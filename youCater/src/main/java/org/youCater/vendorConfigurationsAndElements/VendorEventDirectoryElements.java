...
public class VendorEventDirectoryElements {
	...
	@FindBy(xpath = "//*[contains(@id, \"chat\") and contains(text(), \"chat\")]")
	private WebElement goToChat;

	@FindBy(xpath = "//div[contains(@id,\"sendbird-message-input-text-field\")]")
	private WebElement enterMessage;

	@FindBy(xpath = "//button[contains(@class,'sendbird-message-input--send')]")
	private WebElement sendMessage;

	@FindBy(xpath = "//*[contains(@id, \"quote\") and contains(text(), \"my quote\")]")
	private WebElement goToMyQuote;

	@FindBy(xpath = "//*[contains(@id, \"details\") and contains(text(), \"details\")]")
	...
	@FindBy(className = "addQuoteBtn")
	private WebElement addQuoteButton;
	
	@FindBy(className = "img-hold")
	private WebElement crossButton;

	@FindBy(id = "quoteAmount")
	...
	@FindBy(className = "newQuoteFooterBtn")
...
//		js.executeScript("arguments[0].click();", quoteButton);
	...
	public void enterVAT() {
		wait.until(ExpectedConditions.visibilityOf(VAT)).click();
	}
