...
public class SendBidRequestTestCases extends Configurations {
	...
	public void selecCaterer() throws InterruptedException {
		...
		String targetVendorId = "3254d7ff-f6c3-455d-9869-54bfa938535a";
	...
	public void partnerDetail() throws InterruptedException {
		...
		Thread.sleep(2000);
		List<WebElement> menuList = sendBidRequestElements.viewCatererMenu();

		if (!menuList.isEmpty()) {
			WebElement selectMenu = menuList.get(0);
			selectMenu.click();

		}
		Thread.sleep(2000);
		sendBidRequestElements.closeMenuCard();
		Thread.sleep(2000);
		sendBidRequestElements.aboutCaterer();
		Thread.sleep(2000);

		/*
		 * sendBidRequestElements.catererMenu(); Thread.sleep(2000);
		 */
