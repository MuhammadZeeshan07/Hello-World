...
public class RequestAcceptanceAndQuoteSubmissionTestCases extends VendorConfigurations {
	...
	public void submitQuote() throws InterruptedException {
		 ...
		 * driver.findElement(By.xpath("//*[contains(@class,\"MuiAlert-message\")]"));
		 * String expectedToastMessage = "Bid Placed Successfully!";
		 * softAssert.assertTrue(toastElement.isDisplayed() &&
		 * toastElement.getText().equals(expectedToastMessage),
