...
public class HomePageElements {
	...
	public void searchVendor() {
		...
		wait.until(ExpectedConditions.visibilityOf(searchVendor)).sendKeys("caviar");
	}
	...
	public void acceptPrivacy() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(acceptPrivacy)).click();
	}
	...
	public void submitRegisterationForm() {
		...
		js.executeScript("window.scrollBy(0, 200);");
		wait.until(ExpectedConditions.elementToBeClickable(submitRegisterationForm)).click();
	}
	
	public void clearSearch() {

		wait.until(ExpectedConditions.visibilityOf(searchVendor)).clear();
	}
