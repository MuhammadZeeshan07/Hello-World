...
public class VendorEventDirectoryElements {
	...
	@FindBy(xpath = "//*[@id=\"outlined-basic\" and @type=\"number\"]")
	private WebElement enterQuoteAmount;

	@FindBy(xpath = "//*[@id=\"outlined-basic\" and @type=\"text\"]")
	private WebElement enterQuoteComments;

	@FindBy(xpath = "//*[text()=\"Attach quote\"]")
	...
	@FindBy(xpath = "//button[(text()='Decline event')]")
